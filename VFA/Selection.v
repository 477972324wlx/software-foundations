...
assert (Permutation (x :: l) (n :: l0) -> Permutation (x :: a :: l) (n :: a :: l0) ).
{
intros. 
...
assert (Permutation (a :: l) (n :: l0) -> Permutation (a :: x :: l) (n :: x :: l0) ).
{
intros. 
rewrite perm_swap. apply Permutation_sym.
rewrite perm_swap. apply Permutation_sym.
...
induction n. destruct l. simpl. reflexivity.
