...
(*
Lemma stupid_logic: forall a b:nat, a < b -> a <= b.
Proof.
intros.
discriminate.
Admittted.
...
elim H.
simpl. constructor.
intros. remember (leb a x) as AA. symmetry in HeqAA. destruct AA.
apply leb_complete in HeqAA. simpl. case_eq (a<=?x). intros. apply sorted_cons. apply HeqAA.  constructor.
intros. apply leb_complete_conv in H0. constructor. omega. constructor. 
intros. apply leb_complete_conv in HeqAA. simpl. case_eq (a<=?x). intros. constructor. apply leb_complete in H0. 
apply H0. constructor. 
intros.  simpl. constructor. omega. constructor.
intros. simpl. 
case_eq ( a<=? x ). 
intros. constructor. apply leb_complete in H3. omega. constructor. omega. apply H1.
intros. 
case_eq ( a<=? y ).
intros. constructor. inversion H3. apply leb_complete_conv in H6. omega. 
constructor. apply leb_complete in H4. omega. apply H1.
intros. constructor. apply H0. 
