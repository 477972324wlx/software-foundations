...
unfold is_wp.
  ...
  rewrite t_update_eq. simpl. rewrite plus_comm.
  apply le_n_S; auto.
  intros. unfold hoare_triple in H.
  intros st H1.
  assert (t_update st X ((st Y) + 1 ) X <= 5).
    eapply H.
    constructor. auto. auto.
  rewrite t_update_eq in H0. rewrite plus_comm in H0.
  apply le_S_n. auto.
Qed.
(** [] *)
...
intros. unfold is_wp; split.
  ...
  unfold hoare_triple.
  intros P H st H1.
  assert(Q (t_update st X (aeval st a))).
